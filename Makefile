...
it: clean
	...
	rsp train --config config.toml --batch_size 16 --workers 2 --epochs 5 --dataset it it/pth
	rsp train --config config.toml --batch_size 16 --workers 2 --resume --checkpoint it/pth/checkpoint-00005-of-00005.pth--epochs 10 --dataset it it/pth
	rsp predict --config config.toml --checkpoint it/pth/checkpoint-00010-of-00010.pth --web_ui it/images it/masks
